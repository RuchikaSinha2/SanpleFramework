...
Pod::Spec.new do |spec|
  ...
  #spec.source       = { :path => '.' }
  spec.source       = { :git => "https://github.com/RuchikaSinha2/SanpleFramework.git", :tag => "0.0.2"}
  ...
  spec.author             = { "Ruchika Sinha" => "Ruchika.Sinha@ril.com" }
  # Or just: spec.author    = "Ruchika Sinha"
  # spec.authors            = { "Ruchika Sinha" => "Ruchika.Sinha@ril.com" }
  # spec.social_media_url   = "https://twitter.com/Ruchika Sinha"
